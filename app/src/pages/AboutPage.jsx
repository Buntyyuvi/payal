    ...
    <div className="min-h-screen bg-slate-50">
      <div className="relative h-[50vh] overflow-hidden">
        ...
        <div className="absolute bottom-0 left-0 right-0 p-12 max-w-7xl mx-auto">
          ...
          <h1 className="text-5xl md:text-7xl font-bold text-white mb-3">Every bouquet<br />tells a story</h1>
          <p className="text-slate-200 text-lg max-w-xl">Handcrafted with love, designed to bring smiles.</p>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-8 -mt-20 relative z-10">
        <div className="bg-white rounded-[3rem] p-12 shadow-xl border border-slate-100 mb-12">
          <div className="flex flex-col md:flex-row gap-12 items-center">
            ...
            <div className="w-full md:w-1/2">
              ...
              <h2 className="text-4xl font-bold text-slate-800 mb-2">Payal Mohite</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
          ...
          <div className="h-full rounded-[2rem] overflow-hidden shadow-sm">
